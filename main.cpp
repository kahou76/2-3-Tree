...
//     // cout << "root Small Key: " << root->getSmallKey() << " " << root->getLeft()->getSmallKey()->getKey() << " " << root->getLeft()->getMiddleKey()->getKey() << endl;
//     // cout << " " << root->getMiddleLeft()->getSmallKey()->getKey() << endl;
